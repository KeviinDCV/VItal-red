...
Route::middleware(['auth', 'verified', 'web'])->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('usuarios/{usuario}/permisos', [App\Http\Controllers\Admin\UsuarioController::class, 'permisos'])->name('usuarios.permisos');
        Route::post('usuarios/{usuario}/permisos', [App\Http\Controllers\Admin\UsuarioController::class, 'updatePermisos'])->name('usuarios.permisos.update');
        ...
        Route::get('referencias', [App\Http\Controllers\Admin\ReferenciasController::class, 'dashboard'])->name('referencias');
        Route::post('referencias/{solicitud}/decidir', [App\Http\Controllers\Admin\ReferenciasController::class, 'decidir'])->name('referencias.decidir');
        Route::get('referencias/estadisticas', [App\Http\Controllers\Admin\ReferenciasController::class, 'estadisticas'])->name('referencias.estadisticas');
        
        Route::get('reportes', [App\Http\Controllers\Admin\ReportesController::class, 'index'])->name('reportes');
        Route::get('reportes/exportar', [App\Http\Controllers\Admin\ReportesController::class, 'exportarExcel'])->name('reportes.exportar');
        Route::get('reportes/graficos', [App\Http\Controllers\Admin\ReportesController::class, 'graficos'])->name('reportes.graficos');
        
        Route::get('configuracion-ia', [App\Http\Controllers\Admin\IAConfigController::class, 'index'])->name('configuracion-ia');
        Route::post('configuracion-ia', [App\Http\Controllers\Admin\IAConfigController::class, 'actualizar'])->name('configuracion-ia.actualizar');
        Route::post('configuracion-ia/probar', [App\Http\Controllers\Admin\IAConfigController::class, 'probar'])->name('configuracion-ia.probar');
        
        // Nuevas rutas de vistas
        Route::get('reportes-completos', function() {
        ...
        })->name('reportes-completos');
        
        Route::get('configurar-ia-completo', function() {
        ...
        Route::post('integrations/sync-patient', [App\Http\Controllers\Admin\IntegrationsController::class, 'syncPatient'])->name('integrations.sync-patient');
        Route::post('integrations/test-connection', [App\Http\Controllers\Admin\IntegrationsController::class, 'testConnection'])->name('integrations.test-connection');
        ...
        Route::get('ai', [App\Http\Controllers\Admin\AIController::class, 'dashboard'])->name('ai');
        Route::post('ai/process-document', [App\Http\Controllers\Admin\AIController::class, 'processDocument'])->name('ai.process-document');
        Route::post('ai/feedback', [App\Http\Controllers\Admin\AIController::class, 'submitFeedback'])->name('ai.feedback');
        Route::post('ai/update-weights', [App\Http\Controllers\Admin\AIController::class, 'updateWeights'])->name('ai.update-weights');
        Route::post('ai/test-classification', [App\Http\Controllers\Admin\AIController::class, 'testClassification'])->name('ai.test-classification');
